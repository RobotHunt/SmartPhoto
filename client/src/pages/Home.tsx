    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            <Card className="bg-white border-slate-200 p-3 hover:shadow-md transition-all">
              ...
              <div className="grid grid-cols-3 gap-1">
                <div className="aspect-square rounded-lg overflow-hidden bg-slate-50 flex items-center justify-center text-xs text-slate-400">
                  正面图
                </div>
                <div className="aspect-square rounded-lg overflow-hidden bg-slate-50 flex items-center justify-center text-xs text-slate-400">
                  侧面图
            ...
            <Card className="bg-white border-slate-200 p-3 hover:shadow-md transition-all">
              ...
              <div className="space-y-1">
                <div className="grid grid-cols-3 gap-1">
                  {[
                    { name: '1688', logo: '/platforms/1688.png' },
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-lg mx-auto divide-y divide-slate-100">
            {[
              { icon: <Sparkles className="w-5 h-5 text-slate-600" />, title: '智能批量生成', desc: '批量处理产品图，智能生成多平台适配图片，提高工作效率10倍以上' },
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          {isAuthenticated ? (
            <Button size="lg" variant="secondary" className="text-lg px-8 py-6"
              onClick={startCreateFlow}>
              开始做图 <Sparkles className="ml-2 w-5 h-5" />
            </Button>
          ) : (
            <a href={getLoginUrl()}>
              <Button size="lg" variant="secondary" className="text-lg px-8 py-6">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-100 shadow-[0_-1px_8px_rgba(0,0,0,0.06)]">
        <div className="flex items-center justify-around h-16 max-w-lg mx-auto px-4">
          <Link href="/">
            <button className={`flex flex-col items-center gap-1 px-6 py-2 transition-colors ${
              currentPath === '/' ? 'text-blue-500' : 'text-slate-400 hover:text-slate-600'
            }`}>
          ...
          <Link href="/history">
            <button className={`flex flex-col items-center gap-1 px-6 py-2 transition-colors ${
              currentPath === '/history' ? 'text-blue-500' : 'text-slate-400 hover:text-slate-600'
            }`}>
          ...
          <Link href="/account">
            <button className={`flex flex-col items-center gap-1 px-6 py-2 transition-colors ${
              currentPath === '/account' ? 'text-blue-500' : 'text-slate-400 hover:text-slate-600'
            }`}>
