...
export function StepIndicator(props: StepIndicatorProps) {
  ...
  if ("steps" in props && props.steps) {
    ...
    return (
      <div className="w-full bg-white/90 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
              ...
              <div key={step.number} className="flex items-center flex-1">
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-2 text-center hidden md:block">
                    <div className={`text-xs font-medium ${step.number <= currentStep ? "text-blue-600" : "text-slate-500"}`}>
                      {step.title}
                    </div>
  ...
  return (
    <div className="w-full bg-white/90 backdrop-blur-md border-b border-slate-200 px-4 py-2 sticky top-0 z-50">
              ...
              >
                ...
                <div
                  className={`
                    ...
                    ${isCompleted
                      ? "bg-blue-600 text-white shadow-sm group-hover:bg-blue-500"
                      : isCurrent
                        ? "bg-blue-500 text-white shadow-md ring-2 ring-blue-100"
                ...
                <span
                  className={`text-[10px] whitespace-nowrap leading-none transition-all
                    ${isCompleted
                      ? "text-blue-600 font-medium group-hover:text-blue-500"
                      : isCurrent
