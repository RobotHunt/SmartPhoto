// ============================================================================
// [2026-03-16 静态化改造] 目标：移除 Manus 服务端插件，仅保留纯前端构建插件
// ============================================================================

import { jsxLocPlugin } from "@builder.io/vite-plugin-jsx-loc";
import tailwindcss from "@tailwindcss/vite";
import react from "@vitejs/plugin-react";
// [2026-03-16 静态化改造] 注释掉 Manus 相关 import，静态构建不需要
...
// --- 原始代码：Manus Debug Collector 插件（已注释） ---
// [2026-03-16 静态化改造] 整个 Debug Collector 插件仅用于 Manus 开发环境，静态部署不需要
/*
...
export default defineConfig({
  ...
  server: {
    host: true,
    allowedHosts: [
      // [2026-03-16 静态化改造] 保留 localhost，注释掉 Manus 专用域名
      // ".manuspre.computer",
      // ".manus.computer",
      // ".manus-asia.computer",
      // ".manuscomputer.ai",
